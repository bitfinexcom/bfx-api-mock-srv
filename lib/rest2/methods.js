...
const RESTV2_MOCK_METHODS = {
  ...
  '/v2/auth/w/ext/pay/instant':'pay_instant',
  '/v2/auth/w/ext/pay/upload/image':'pay_upload_image',
  '/v2/auth/r/ext/pay/credit-card/rates':'pay_credit_card_rates',
  '/v2/ext/pay/invoice/currency/detailed':'pay_invoice_currency_detailed',
  '/v2/auth/r/ext/pay/currency/detailed':'pay_currency_detailed',
  '/v2/auth/r/ext/pay/currency/list':'pay_currency_list',
  '/v2/ext/pay/invoice/feedback':'pay_invoice_feedback',
  '/v2/auth/w/ext/pay/merchant/feedback':'pay_merchant_feedback',
  '/v2/auth/ext/pay/invoice/update':'pay_public_invoice_update',
  '/v2/auth/w/ext/pay/invoice/update':'pay_invoice_update',
  '/v2/ext/pay/invoice/regenerate':'pay_invoice_regenerate',
